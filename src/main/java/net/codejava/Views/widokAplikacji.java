			...
			public void actionPerformed(ActionEvent a) {
				if (HibernateOracle.obiekt instanceof Produkty) {
					...
					try (Session sesja2 = bd.pobierzSesjeBD()) {
						...
						Query<Obiekt_Do_Polecen> zapytanie = null;
						zapytanie = sesja2.createQuery("FROM Producenci order by id_producenta",
					...
					try (Session sesja2 = bd.pobierzSesjeBD()) {
						...
						zapytanie = sesja2.createQuery(
								...
								Obiekt_Do_Polecen.class); // tututki
						obiekty = zapytanie.getResultList();
						bd.zamknijSesjeBD();
					} catch (Exception e) {
						e.printStackTrace();
					...
					try (Session sesja2 = bd.pobierzSesjeBD()) {
						...
						Query<Obiekt_Do_Polecen> zapytanie = null;
						zapytanie = sesja2.createQuery("FROM Uzytkownicy order by id_uzytkownika",
								Obiekt_Do_Polecen.class);
						obiekty = zapytanie.getResultList();
						bd.zamknijSesjeBD();
					} catch (Exception e) {
